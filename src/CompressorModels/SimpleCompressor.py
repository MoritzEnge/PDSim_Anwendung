...
class SimpleCompressor(PDSimCore):
    def __init__(self):
...
def simulate_Compressor(pe,pc,T0,datapath):
    ...
    comp.d_discharge = 0.003
    comp.d_suction = 0.005
    ...
    mdot_guess = inletState.rho*comp.Vdisp*comp.omega/(2*pi)
